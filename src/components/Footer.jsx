            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li>
                            <a href="mailto:fusionpharma@example.com" className="text-gray-300 hover:text-white text-sm">
                                Email : fusionpharma024@gmail.com
                            </a>
                        </li>
                        <li>
                            <a href="tel:+9779848586825" className="text-gray-300 hover:text-white text-sm">
                                Phone : +977 9848586825
                            </a>
                        </li>
                        <li>

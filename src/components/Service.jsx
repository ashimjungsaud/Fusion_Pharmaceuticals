...
const Service = () => {
    return (
        <section className="bg-white lg:pb-[90px] lg:pt-[120px]">
                    ...
                    <ServiceCard
                        ...
                        icon={
                            <svg
                                ...
                                viewBox="0 0 36 36"
                                fill="none"
                                xmlns="https://www.svgrepo.com/show/530618/hotel.svg"
                            >
                                <path
    ...
    return (
        <>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-9 rounded-[20px]  p-10 shadow-2xl hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10">
                    <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-emerald-400">
                        {icon}
                    </div>
